...
"}")
        ...
        self.LeftSBar.setMaximumSize(QSize(400, 16777215))
...
"}")
        ...
        self.MainBar.setMaximumSize(QSize(900, 16777215))
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.top_rsb.sizePolicy().hasHeightForWidth())
        self.top_rsb.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.playlist_name_rsb.sizePolicy().hasHeightForWidth())
        self.playlist_name_rsb.setSizePolicy(sizePolicy2)
        ...
        self.scroll_rsb.setGeometry(QRect(0, 0, 318, 542))
        self.verticalFrame = QFrame(self.scroll_rsb)
        self.verticalFrame.setObjectName(u"verticalFrame")
        self.verticalFrame.setGeometry(QRect(20, 20, 275, 275))
        self.verticalFrame.setMinimumSize(QSize(275, 275))
        self.verticalFrame.setMaximumSize(QSize(500, 500))
        self.verticalLayout_3 = QVBoxLayout(self.verticalFrame)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.label = QLabel(self.verticalFrame)
        self.label.setObjectName(u"label")
        self.label.setPixmap(QPixmap(u":/images/img/default_cover.jpg"))
...
"")
        ...
        sizePolicy5.setHeightForWidth(self.right_panel.sizePolicy().hasHeightForWidth())
        self.right_panel.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.SeekBar.sizePolicy().hasHeightForWidth())
        self.SeekBar.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.left_panel.sizePolicy().hasHeightForWidth())
        self.left_panel.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.small_cover.setPixmap(QPixmap(u":/images/img/default_cover.jpg"))
        ...
        self.audio_frame = QFrame(self.lp_frame)
        self.audio_frame.setObjectName(u"audio_frame")
        sizePolicy3.setHeightForWidth(self.audio_frame.sizePolicy().hasHeightForWidth())
        self.audio_frame.setSizePolicy(sizePolicy3)
        self.audio_frame.setStyleSheet(u"QLabel{\n"
"	font: 700 10pt \"Onest\";\n"
"}\n"
"\n"
"#pp_artist_lb{\n"
